...
export default function ToolCard({ tool, animationDelay }: ToolCardProps) { 
  return ( 
    <motion.div 
      ...
      className="tool-card bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer" > 
      <Link href={`/tools/${tool.slug}`}> 
        <div className={`tool-card-icon h-20 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600`}> 
