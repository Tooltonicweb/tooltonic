...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://tooltonic.io/features',
    type: 'website',
    images: [
      {
...
export default function FeaturesPage() {
  return (
    <>
      <Head>
        <link rel="canonical" href="https://tooltonic.io/features" />
      </Head>
      ...
      <section className="container mx-auto px-4 py-12 animate-fade">
        <h1 className="text-3xl font-bold text-center mb-6 text-primary">Features</h1>
